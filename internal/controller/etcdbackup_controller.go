...
//+kubebuilder:rbac:groups=etcd.uisee.com,resources=etcdbackups,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=etcd.uisee.com,resources=etcdbackups/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=etcd.uisee.com,resources=etcdbackups/finalizers,verbs=update
